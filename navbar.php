...
<nav class="navbar navbar-expand-lg" style="border-bottom: 1px solid black">
    ...
    <button class="drawer-menu" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="background-color: transparent; border: 0px"><i class="fa-solid fa-bars fa-xl"></i></button>
